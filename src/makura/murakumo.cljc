...
(def cell-specs {
  :pillow_polyol_attestation {:legacy-cell "pillow-polyol-attestation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_polyol_attestation")]
  ...
  :pillow_isocyanate_dispensing {:legacy-cell "pillow-isocyanate-dispensing"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_isocyanate_dispensing")]
     :required-gates common-gates
     :trigger "manifest cell pillow_isocyanate_dispensing"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_foam_blowing {:legacy-cell "pillow-foam-blowing"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_foam_blowing")]
     :required-gates common-gates
     :trigger "manifest cell pillow_foam_blowing"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_foam_shredding {:legacy-cell "pillow-foam-shredding"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_foam_shredding")]
     :required-gates common-gates
     :trigger "manifest cell pillow_foam_shredding"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_fabric_attestation {:legacy-cell "pillow-fabric-attestation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_fabric_attestation")]
     :required-gates common-gates
     :trigger "manifest cell pillow_fabric_attestation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_shell_sewing {:legacy-cell "pillow-shell-sewing"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_shell_sewing")]
     :required-gates common-gates
     :trigger "manifest cell pillow_shell_sewing"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_filling_close {:legacy-cell "pillow-filling-close"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_filling_close")]
     :required-gates common-gates
     :trigger "manifest cell pillow_filling_close"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_qc {:legacy-cell "pillow-qc"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_qc")]
     :required-gates common-gates
     :trigger "manifest cell pillow_qc"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pillow_packaging {:legacy-cell "pillow-packaging"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pillow_packaging")]
     :required-gates common-gates
